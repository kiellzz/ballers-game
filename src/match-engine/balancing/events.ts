...
export const ACTION_DEFINITIONS: Record<ActionType, ActionDefinition> = {
  ...
  offensiveWeights: [
    { stat: "overall", weight: 0.25 },
    { stat: "defending", weight: 0.57 },
    { stat: "physical", weight: 0.65 },
  ],
  defensiveWeights: [
    { stat: "overall", weight: 0.36 },
    { stat: "dribbling", weight: 0.57 },
    { stat: "physical", weight: 0.52 },
  ],
  ...
  defensiveRecoverRange: { min: 0, max: 0 },
